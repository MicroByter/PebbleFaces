...
static void set_text_to_window() {
  ...
  hour_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_poke_42));
  //Time TextLayer 
  ...
  //Time TextLayer 
  date_layer = text_layer_create(GRect(0, 135, 144, 14));
...
static void main_window_load(Window *window) {
  ...
  clock_bitmap = gbitmap_create_with_resource(RESOURCE_ID_image_black);
